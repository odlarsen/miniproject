...
for i in x:
    ...
    os.system("~/Software/bbmap/bbduk.sh in=./"+i+"/"+file1+" in2=./"+i+"/"+file2 +" out=trimmed_"+file1+" out2=trimmed_"+file2+" threads=16")
    # use SPAdes to assemble genome
    os.system("~/SPAdes/SPAdes-3.14.1-Linux/bin/spades.py -1 trimmed_"+file1+" -2 trimmed_"+file2+" -o ./results/"+i+"_assembly --only-assembler -k 55,77,99,127")
